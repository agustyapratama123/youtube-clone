  ...
  return (
    <div className="header">
      ...
      <div className="header__icons">
        ...
        <Avatar
          alt="agustya pratama"
          src="https://scontent.fcgk7-2.fna.fbcdn.net/v/t31.0-1/p160x160/27788431_1371893129581290_2698036183243085158_o.jpg?_nc_cat=103&_nc_sid=dbb9e7&_nc_ohc=jcyDQpT-01cAX92CCPb&_nc_ht=scontent.fcgk7-2.fna&tp=6&oh=0f5f00573d4ec599df2dd70b2c372877&oe=5F929A2E"
        />
      </div>
    </div>
  );
